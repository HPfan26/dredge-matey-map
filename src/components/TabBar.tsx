    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center" style={{ paddingBottom: "max(env(safe-area-inset-bottom, 12px), 12px)" }}>
      <nav
        ...
        style={{
          ...
          WebkitBackdropFilter: "blur(50px) saturate(2.2) brightness(1.05)",
          border: "1px solid hsla(0, 0%, 88%, 0.6)",
          boxShadow: "inset 0 1px 0 0 hsla(0, 0%, 100%, 0.5), 0 4px 20px -4px hsla(0, 0%, 0%, 0.1)",
        }}
      >
        {tabs.map((tab) => {
